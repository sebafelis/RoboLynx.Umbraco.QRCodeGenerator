...
namespace RoboLynx.Umbraco.QRCodeGenerator.QRCodeFormat
{
    ...
    {
        public JpegFormat(ILocalizedTextService localizedTextService, IMediaService mediaFileSystem, UmbracoHelper umbracoHelper, IColorParser colorParser) : base(localizedTextService, mediaFileSystem, umbracoHelper, colorParser)
        {
