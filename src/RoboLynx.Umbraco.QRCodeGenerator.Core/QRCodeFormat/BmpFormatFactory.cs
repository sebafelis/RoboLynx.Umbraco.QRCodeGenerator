...
namespace RoboLynx.Umbraco.QRCodeGenerator.QRCodeFormat
{
    public class BmpFormatFactory : QRCodeFormatFactory
    {
        ...
        public BmpFormatFactory(ILocalizedTextService localizedTextService, IMediaFileSystem mediaFileSystem, UmbracoHelper umbracoHelper, IQRCodeHashIdFactory hashIdFactory, IColorParser colorParser) : base(localizedTextService)
        {
        ...
        {
            return new BmpFormat(_mediaFileSystem, _umbracoHelper, _hashIdFactory, _colorParser, codeType, settings);
        }
    }
}
