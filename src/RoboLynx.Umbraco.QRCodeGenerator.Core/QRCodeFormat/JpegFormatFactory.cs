...
namespace RoboLynx.Umbraco.QRCodeGenerator.QRCodeFormat
{
    public class JpegFormatFactory : QRCodeFormatFactory
    {
        ...
        public JpegFormatFactory(ILocalizedTextService localizedTextService, IMediaService mediaService, UmbracoHelper umbracoHelper, IQRCodeHashIdFactory hashIdFactory, IColorParser colorParser) : base(localizedTextService)
        {
        ...
        {
            return new JpegFormat(_mediaService, _umbracoHelper, _hashIdFactory, _colorParser, codeType, settings);
        }
    }
}
