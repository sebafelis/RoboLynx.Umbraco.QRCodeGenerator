...
namespace RoboLynx.Umbraco.QRCodeGenerator
{
    ...
    {
        public static Stream GetStream(this QRCodeService service, QRCode property, string culture, QRCodeSettings settings)
        {
            return service.GetStream(property.PublishedContent, property.PropertyAlias, culture, settings, property.CacheName);
        }

        public static Stream GetStream(this QRCodeService service, QRCode property, string culture, QRCodeSettings settings, string cacheName)
        {
            return service.GetStream(property.PublishedContent, property.PropertyAlias, culture, settings, cacheName);
        }

        public static QRCodeSettings GetDefaultSettings(this QRCodeService service, QRCode property)
        {
